...
public class LDashboardController {
    public AnchorPane dashoard;
    public ImageView icnUsers;
    public ImageView icnBooks;
    public ImageView icnReturn;
    public ImageView icnIssue;
    public ImageView icnSearch;
    ...
    private void navigate(MouseEvent event) throws IOException {
        if (event.getSource() instanceof ImageView){
            ...
            switch(icon.getId()){
                case "icnUsers":
                    root = FXMLLoader.load(this.getClass().getResource("/View/Members.fxml"));
                    break;
                case "icnBooks":
                    root = FXMLLoader.load(this.getClass().getResource("/View/Books.fxml"));
                    break;
                case "icnIssue":
            ...
            if (root != null){
                ...
                Stage primaryStage = (Stage) this.dashoard.getScene().getWindow();
